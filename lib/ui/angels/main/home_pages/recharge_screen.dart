...
class _AllChargesScreenState extends State<AllChargesScreen> {
  MyWalletScreenController myWalletScreenController = Get.find();
              ...
              child: Column(
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          "(${controller.getAllRechargeResModel.data?.length ?? '0'})"
                  ...
                  controller.isLoading == true
                      ...
                      : controller.getAllRechargeResModel.data == [] ||
                                                              ...
                                                              children: <Widget>[
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        "₹${controller.getAllRechargeResModel.data?[index].discountAmount ?? ''}.00".regularAllertaStencil(
                                                                            fontColor:
                                                                                blackColor),
                                                                        const Spacer(),
                                                                        TextButton(
