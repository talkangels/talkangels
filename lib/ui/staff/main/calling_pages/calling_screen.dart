...
class CallingScreen extends StatefulWidget {
  ...
  CallingScreen({Key? key}) : super(key: key);
...
class _CallingScreenState extends State<CallingScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      callingScreenController.setAgoraDetails(
          message.data['channelName'], message.data['agora_app_id'], message.data['agora_token'], message.data['_id']);
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    (h * 0.05).addHSpace(),
                    message.data['name'].toString().regularLeagueSpartan(fontSize: 34, fontWeight: FontWeight.w800),
                    ...
                    RippleAnimation(
                        ...
                        child: message.data['image'] == "" || message.data['image'] == "0"
                            ? const CircleAvatar(
                                minRadius: 75, maxRadius: 75, backgroundImage: AssetImage(AppAssets.blankProfile))
                            : CircleAvatar(
                                minRadius: 75, maxRadius: 75, backgroundImage: NetworkImage(message.data['image']))),
                    const Spacer(),
                    (h * 0.03).addHSpace(),
                    Container(
                      height: h * 0.17,
